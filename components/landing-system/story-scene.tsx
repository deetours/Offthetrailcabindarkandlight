...
export function StoryScene({ numeral, headline, paragraphs, mainImageSrc, insetImageSrc }: StorySceneProps) {
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative flex flex-col md:flex-row min-h-screen bg-[#0C0F0D] overflow-hidden"
    >
      ...
      <div className="relative w-full md:w-[55%] h-[60vh] md:h-screen md:sticky md:top-0 z-10">
        ...
        {/* Gradient fade to black on bottom for mobile only */}
        <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#0C0F0D] to-transparent md:hidden z-20" />
        ...
        <motion.div 
          ...
          className="hidden md:block absolute bottom-12 -right-16 lg:-right-24 w-48 lg:w-64 aspect-[3/4] z-30 shadow-2xl border border-[#151A17] bg-[#151A17] overflow-hidden origin-bottom-right transition-transform duration-500"
        >
          <Image
            src={insetImageSrc}
            alt="Detail view"
      ...
      <div className="md:hidden relative w-full px-6 -mt-8 mb-12 z-20">
        <div className="relative w-1/2 ml-auto aspect-[3/4] shadow-xl border border-[#151A17] overflow-hidden">
           <Image
            src={insetImageSrc}
            alt="Detail view"
            fill
      ...
      <div className="relative w-full md:w-[45%] flex flex-col justify-center px-6 md:pl-16 lg:pl-24 md:pr-16 py-16 md:py-32 z-20">
        ...
        <div className="max-w-xl">
          ...
          <motion.div
            ...
            className="font-serif text-[#C9A227] text-lg lg:text-xl italic mb-4"
          >
            {numeral}
          </motion.div>
          ...
          <motion.h2
            ...
            className="font-serif text-3xl md:text-4xl lg:text-5xl text-[#EDEAE2] mb-12"
          >
            {headline}
          </motion.h2>
            ...
            {paragraphs.map((p, i) => {
              if (p.isQuote) {
                return (
                  <motion.blockquote
                    ...
                    className="relative pl-6 lg:pl-8 py-2 font-serif italic text-xl lg:text-2xl text-[#EDEAE2] leading-relaxed my-12"
                  >
                    ...
                    <motion.div 
                      ...
                      className="absolute left-0 top-0 w-[2px] h-full bg-[#C9A227] origin-top"
                    />
                    {p.text}
                  </motion.blockquote>
                )
              ...
              return (
                <motion.p
                  ...
                  viewport={{ once: true, margin: "-100px" }}
                  transition={{ duration: 0.8, delay: 0.2 + (i * 0.1), ease: "easeOut" }}
                  className="font-sans text-[#8B9A8C] text-base lg:text-lg leading-relaxed font-light"
                >
                  {p.text}
                </motion.p>
              )
